...
INSERT INTO "user" (firstname, lastname, pseudo, mail, "password", phone_number, role_id, localisation_id) VALUES
...
INSERT INTO "user" (firstname, lastname, pseudo, mail, "password", phone_number, localisation_id) VALUES
...
('7Wonders excellent état', 'je loue 7Wonders', 5, 'https://blalbla', '7Wonders', 'Antoine Bauza', 2010, '60 minutes', 2, 7, 8, 5, 4),
('Catan excellent état', 'je loue Catan', 5, 'https://blalbla', 'Catan', 'Klaus Teber', 2005, '55 minutes', 2, 7, 10, 5, 3),
('Risk', 'je loue Risk', 10, 'https://blalbla', 'Risk', 'Albert Lamorisse', 1998, '30 minutes', 3, 5, 5, 7, 5),
('Colt Express', 'je loue Colt express', 8, 'https://blalbla', 'Colt Express', 'JeSaisPas', 2002, '50 minutes', 3, 6, 10, 2, NULL),
('Jungle Speed', 'je loue Jungle Speed', 2, 'https://blalbla', 'Jungle Speed', 'Thomas Vuarchex & Pierric Yakovenko',2000, '10 minutes', 2, 160, 6, 1, 6);
